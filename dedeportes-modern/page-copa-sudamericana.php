    ...
    <div class="container" style="padding-top: 3rem; padding-bottom: 5rem;">
        ...
        <header class="page-header" style="margin-bottom: 4rem; text-align: center;">
            <h1 class="page-title" style="font-size: 3rem; margin-bottom: 0.75rem; font-weight: 800; color: #0f172a;">
                Tabla de Posiciones Copa Sudamericana</h1>
                ...
                <?php else: ?>
                    ...
                    <div
                        ...
                        <p style="margin: 0; font-weight: 600;">
                            ...
                            <span
                                style="display:inline-block; width:12px; height:12px; background:#38bdf8; border-radius: 2px; margin-left:20px; margin-right:5px;"></span>
